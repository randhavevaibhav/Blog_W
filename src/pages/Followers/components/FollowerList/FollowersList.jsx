...
import { Follower } from "@/components/common/Follower/Follower";
import { v4 as uuidv4 } from "uuid";
import { FollowersSkeletonItem } from "@/pages/Followers/components/FollowersSkeleton";
...
export const FollowersList = forwardRef(({ followers, isFetching }, ref) => {
  ...
  return (
    <div id="followers_grid" className="lg:px-0 px-4 mx-auto max-w-[60rem]">
