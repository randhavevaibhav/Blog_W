...
export const UserInfo = forwardRef(({register,errors},ref) => {
 ...
 const userNameErrMsg = errors.userName?.message;
  ...
  const handleImgChange = () => {
    const profileImgFile = ref.current.files
      ? ref.current.files[0]
      : null;
      ...
      <CardContent>
        <div className="grid w-full items-center gap-2">
          <div className="flex flex-col space-y-1.5">
            <Label htmlFor="userName" className="!text-fs_base">User Name</Label>
            <Input
              id="userName"
            ...
            />
            <ErrorText
              className={`${userNameErrMsg ? `visible` : `invisible`} min-h-4`}
            >
              {userNameErrMsg}
            </ErrorText>
          </div>
          <div className="flex flex-col space-y-1.5">
            <Label htmlFor="mail" className="!text-fs_base">Email</Label>
            <Input
              id="mail"
            ...
            />
            <ErrorText
              className={`${userMailErrMsg ? `visible` : `invisible`} min-h-4`}
            >
              {userMailErrMsg}
            </ErrorText>
          </div>
          <div className="flex flex-col space-y-1.5 relative">
            <Label htmlFor="password" className="!text-fs_base">Old password</Label>
            <Input
              id="oldPassword"
          ...
          <div className="flex flex-col space-y-1.5 relative">
            <Label htmlFor="password" className="!text-fs_base">Password</Label>
            <Input
              id="password"
              type={showPass ? `password` : `text`}
          ...
          <div className="flex items-center gap-2 space-y-1.8 mb-4">
            <Label htmlFor="profile_pic" className="!text-fs_base">Select profile image</Label>
            <div className="">
